...
// Function to find the greatest product of four adjacent numbers in the grid
long long findGreatestProduct(){
...
int main(){
    long long result = findGreatestProduct();
    printf("The greatest product of four adjacent numbers in the grid is: %lld\n", result);
